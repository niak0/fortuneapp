class Env {
  ...
  static const String scheduledJobs = String.fromEnvironment(
    'FIREBASE_SCHEDULED_JOBS_COLLECTION',
  );
  static const String fortunes = String.fromEnvironment(
    'FIREBASE_FORTUNES_COLLECTION',
  );
